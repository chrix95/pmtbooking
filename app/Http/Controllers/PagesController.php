    ...
    public function terminal () {
        $terminal = [
            ...
            [
                ...
                "number"=> "08055091858",
                "address"=> "Gwagwalada Road, Near Secretariat Junction, Kuje, Abuja."
            ],
            [
                "id"=> 9,
                "depot"=> "ABUJA,UTAKO",
            ...
            [
                ...
                "address"=> "Flyover Bridge, Ketu Road, Beside Biode Garage, Ojota"
            ],
            [
                "id"=> 33,
            ...
            [
                ...
                "manager"=> "Odo Fimber",
                "number"=> "08056697027",
                "address"=> "David Mark Road, Opposite INEC Office, Minna, Niger"
            ],
            [
                "id"=> 37,
                "depot"=> "NNEWI",
